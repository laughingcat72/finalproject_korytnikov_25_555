...
class RatesUpdater:
    ...
    Строго по заданию: "Класс RatesUpdater должен быть точкой входа для логики парсинга"
    """

    def __init__(self, config: ParserConfig = None):  # type: ignore
        self.config = config or ParserConfig()

        # Инициализируем клиенты API как в задании
    ...
    def run_update(self, source: str = None) -> Dict:  # type: ignore
        ...
        Строго по заданию: "run_update() вызывает fetch_rates() у каждого клиента"
        """
        logger.info("=" * 50)
        ...
        try:
            # 1. Обновляем криптовалюты (CoinGecko)
            ...
            # 2. Обновляем фиатные валюты (ExchangeRate-API)
    ...
    def get_cache_info(self) -> Dict:
        """Возвращает информацию о текущем кеше"""
